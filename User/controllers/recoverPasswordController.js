...
const forgotPassword = async (req, res) => {
  try {
    ...
    const resetLink = await userService.forgotPassword(email, EMAIL_SECRET, FRONTEND_URL);
...
const resetPassword = async (req, res) => {
  try {
    ...
    // Reset the password
    const isPasswordReset = await userService.resetPassword(token, newPassword, EMAIL_SECRET);
